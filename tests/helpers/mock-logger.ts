...
/**
 * Mock logger with vi.fn spies on every method.
 * Uses type assertion — the spies accept any args and return any, which is
 * a widening of Logger's narrow signatures (safe for test fakes).
 */
